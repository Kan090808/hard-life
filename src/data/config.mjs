...
export const ACTIONS = {
  ...
  gig: { id: "gig", label: "去跑 foodpanda 外送", tone: "income", icon: "scooter", periods: ["afternoon"], effects: { money: 800, energy: -16, stress: 6 }, outcomes: { good: { effects: { money: 200, stress: -2 }, text: "剛好遇到加成時段，幾張單都很順路。" }, bad: { effects: { money: -200, energy: -4, stress: 5 }, text: "等單和找地址花掉大半時間，收入比預期少。" } } },
  tempWork: { id: "tempWork", label: "去打工", tone: "income", icon: "store", periods: ["afternoon"], effects: { money: 760, energy: -20, stress: 9 }, outcomes: { good: { effects: { money: 160, stress: -3 }, text: "現場提早收工，主辦還多補了一筆車馬費。" }, bad: { effects: { money: -160, energy: -5, stress: 6 }, text: "工作內容臨時加碼，薪水卻沒有跟著增加。" } } },
