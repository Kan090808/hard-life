...
export const ACTIONS = {
  ...
  repairComputer: { id: "repairComputer", label: "把筆電送修", tone: "utility", icon: "monitor", periods: ["afternoon"], effects: { money: -1000, stress: -5 }, outcomes: { good: { effects: { money: 220, stress: -2 }, text: "只是接點鬆脫，店家退回一部分預收費。" }, bad: { effects: { money: -220, stress: 5 }, text: "檢測後需要多換一個零件，修理費又增加。" } } },
