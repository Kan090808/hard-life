...
export const ACTIONS = {
  ...
  scrollPhone: {
    ...
    label: "滑手機",
    tag: "不耗時段",
    description: "滑一下手機，不花體力也不占時段。可能放鬆，也可能越滑越空。",
    intensity: "light",
    category: "recovery",
    special: "scrollPhone",
    slotCost: 0,
    eventTags: ["phone", "recovery"],
  },
  repairScooter: {
    id: "repairScooter",
    label: "修理機車",
...
export const WORK_GIGS = [
  { id: "breakfast-prep", label: "早餐店備料", timeSlot: "morning", minEnergy: 30, type: "physical", effects: { money: 480, energy: -20, mood: -3, stress: 4 } },
  { id: "market-carry", label: "菜市場搬貨", timeSlot: "morning", minEnergy: 45, type: "physical", effects: { money: 620, energy: -30, mood: -5, stress: 6 } },
  { id: "commute-flyer", label: "通勤口發傳單", timeSlot: "morning", minEnergy: 20, type: "social", effects: { money: 450, energy: -18, mood: -2, stress: 5 } },
  { id: "lunch-rush", label: "便當店午餐尖峰", timeSlot: "afternoon", minEnergy: 30, type: "physical", effects: { money: 650, energy: -28, mood: -6, stress: 8 } },
  { id: "warehouse-sort", label: "倉庫理貨", timeSlot: "afternoon", minEnergy: 45, type: "physical", effects: { money: 780, energy: -34, mood: -7, stress: 9 } },
  { id: "dishwash", label: "餐廳洗碗", timeSlot: "afternoon", minEnergy: 30, type: "physical", effects: { money: 600, energy: -30, mood: -8, stress: 8 } },
  { id: "night-market", label: "夜市攤位", timeSlot: "evening", minEnergy: 30, type: "social", effects: { money: 700, energy: -25, mood: -4, stress: 8 } },
  { id: "dinner-delivery", label: "晚餐外送", timeSlot: "evening", minEnergy: 30, type: "mixed", effects: { money: 760, energy: -28, mood: -5, stress: 10 } },
  { id: "event-strike", label: "活動撤場", timeSlot: "evening", minEnergy: 45, type: "physical", effects: { money: 850, energy: -36, mood: -8, stress: 12 } },
];
